/**
 * Juntos veremos como utilizamos os princípios de POO em uma API.
 *  Para isso utilizaremos a API desenvolvida na aula passada para
 * gerenciamento do quadro de funcionários que está utilizando a estrutura
 * funcional e a mudaremos para POO usando classes e routers.
 */
...
let address = [
	...
	{
		id: 4,
		street: "Rua doutor alexandre pinheiros",
		city: "São Paulo",
		num: 97,
		state: "SP",
	},
